    ...
    <Center className="p-[1rem] sm:p-[2rem]">
      ...
      >
        <h2 className="text-[1.5rem] sm:text-[3rem] font-sora font-[500]">
          Thankyou for your <br /> Blessing and wishes✨
        </h2>
        <p className="text-basic max-w-[50rem] font-thin">
          "Explore the highlights of our special day in the gallery. We’ll be
          adding more photos after the wedding, so check back soon for updated
          memories!"
        </p>
        <span className="border-dull bg-dull w-[100%] h-[1px]" />
        <p className="text-basic text-white ml-auto font-normal cursor-pointer">
          Back to top
        </p>
      </VStack>
    </Center>
